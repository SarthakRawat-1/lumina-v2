...
import { focusNearestDescendant, isKeyboardInput } from '@/components/editor/utils/focusUtils';
...
export default function DropDown({
  ...
  useEffect(() => {
    ...
    if (button !== null && showDropDown) {
      ...
      document.addEventListener('click', handle as EventListener);

      return () => {
        document.removeEventListener('click', handle as EventListener);
      };
    }
