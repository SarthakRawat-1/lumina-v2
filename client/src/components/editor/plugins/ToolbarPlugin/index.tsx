...
import DropDown, { DropDownItem } from '@/components/editor/ui/DropDown';
import DropdownColorPicker from '@/components/editor/ui/DropdownColorPicker';
import { isKeyboardInput } from '@/components/editor/utils/focusUtils';
...
import { InsertYouTubeDialog } from '../YouTubePlugin/InsertYouTubeDialog';
  ...
  return (
    <div className="toolbar">
          ...
          {canViewerSeeInsertDropdown && (
            <>
              ...
              <DropDown
                ...
                <DropDownItem
                  onClick={() =>
                    dispatchToolbarCommand(INSERT_PAGE_BREAK_COMMAND)
                  }
                  className="item">
                ...
                <DropDownItem
                  ...
                  <span className="text">Excalidraw Diagram</span>
                </DropDownItem>
              </DropDown>
            </>
          )}
      ...
      <DropDown
        ...
        buttonClassName="toolbar-item spaced"
        buttonLabel="Export"
        buttonAriaLabel="Export document content"
        buttonIconClassName="icon export">
        <DropDownItem
          onClick={() => {
            activeEditor.update(() => {
        ...
        <DropDownItem
          onClick={() => {
            const rootElement = activeEditor.getRootElement();
            if (rootElement) {
              const text = rootElement.innerText || rootElement.textContent || '';
        ...
        <DropDownItem
            ...
            if (rootElement) {
              ...
              if (printWindow) {
                printWindow.document.write(`
                  ...
                  <body>${rootElement.innerHTML}</body>
                  </html>
                `);
          ...
          className="item">
          <i className="icon page-break" />
          <span className="text">PDF (Print)</span>
        </DropDownItem>
      </DropDown>
      <Divider />
