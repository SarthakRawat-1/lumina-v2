...
export default function LoginPage() {
  ...
  // Show test credentials alert on page load
  useEffect(() => {
    alert(
      "To test the app without creating an account, please use these credentials:\n\n" +
  ...
  return (
    <div className="min-h-screen bg-[#121212] flex flex-col items-center justify-center px-4 font-sans text-white relative">
      {/* Top Left Logo */}
